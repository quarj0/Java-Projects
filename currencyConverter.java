...
public class currencyConverter {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Quarjo\\Downloads\\currency-g156cde642_1280.png"));
		...
		convertFrom.setForeground(SystemColor.text);
		...
		txtFrom.setToolTipText("Select cuurency to convert from");
		...
		convertTo.setForeground(SystemColor.text);
