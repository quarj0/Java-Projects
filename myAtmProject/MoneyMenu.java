	...
	private void initialize() {
		...
		btn20.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(btn20, "You have successfully withdraw Gh¢20.0");
			}
		});
		...
		btn50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(btn50, "You have successfully withdraw Gh¢50.0");
			}
		});
		...
		btn100.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(btn100, "You have successfully withdraw Gh¢100.0");
			}
		});
		...
		btn500.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(btn500, "You have successfully withdraw Gh¢500.0");
			}
		});
		...
		btn1000.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(btn1000, "You have successfully withdraw Gh¢1000.0");
			}
		});
		...
		btn2000.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(btn2000, "You have successfully withdraw Gh¢2000.0");
			}
		});
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					short sika = 10;
					double amount = (short)Double.parseDouble(txtInput.getText());
					if(amount < sika) {
						JOptionPane.showMessageDialog(btnOk, "Enter amount in multiples of 5");
					}else if(amount > 3000) {
						JOptionPane.showMessageDialog(btnOk, "The amount you're trying to withdraw exceeds limit.");
					}else {
						JOptionPane.showMessageDialog(btnOk, " You have successfully withdraw GH¢"+amount);
						txtInput.setText(null);
					}
				}catch (Exception error) {
					JOptionPane.showMessageDialog(btnOk, "Enter a valid amount!");
				}
