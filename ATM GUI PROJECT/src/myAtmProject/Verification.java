...
public class Verification {
	...
	private void initialize() {
		...
		verifyPAnel.setBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), "Verification", 
		...
		btnVerify.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(verifyPAnel, "Verification successful");
